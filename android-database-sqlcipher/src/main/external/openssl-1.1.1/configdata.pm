...
our %config = (
  ...
  ARFLAGS => [ "r" ],
  CC => "gcc",
  CFLAGS => [ "-Wall -O3", "-fPIC", "--sysroot=/tmp/sqlcipher-android-toolchain-arm64-v8a/sysroot" ],
  CPPDEFINES => [ "__ANDROID_API__=21", "_FILE_OFFSET_BITS=64" ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CROSS_COMPILE => "aarch64-linux-android-",
  CXX => "g++",
  CXXFLAGS => [ "-Wall -O3", "-fPIC", "--sysroot=/tmp/sqlcipher-android-toolchain-arm64-v8a/sysroot" ],
  ...
  build_infos => [ "./build.info", "crypto/build.info", "ssl/build.info", "apps/build.info", "test/build.info", "util/build.info", "tools/build.info", "fuzz/build.info", "crypto/objects/build.info", "crypto/md5/build.info", "crypto/sha/build.info", "crypto/hmac/build.info", "crypto/ripemd/build.info", "crypto/poly1305/build.info", "crypto/blake2/build.info", "crypto/siphash/build.info", "crypto/sm3/build.info", "crypto/des/build.info", "crypto/aes/build.info", "crypto/aria/build.info", "crypto/sm4/build.info", "crypto/chacha/build.info", "crypto/modes/build.info", "crypto/bn/build.info", "crypto/rsa/build.info", "crypto/dso/build.info", "crypto/buffer/build.info", "crypto/bio/build.info", "crypto/stack/build.info", "crypto/lhash/build.info", "crypto/rand/build.info", "crypto/err/build.info", "crypto/evp/build.info", "crypto/asn1/build.info", "crypto/pem/build.info", "crypto/x509/build.info", "crypto/x509v3/build.info", "crypto/conf/build.info", "crypto/txt_db/build.info", "crypto/pkcs7/build.info", "crypto/pkcs12/build.info", "crypto/comp/build.info", "crypto/ocsp/build.info", "crypto/ui/build.info", "crypto/cms/build.info", "crypto/ts/build.info", "crypto/cmac/build.info", "crypto/ct/build.info", "crypto/async/build.info", "crypto/kdf/build.info", "crypto/store/build.info", "test/ossl_shim/build.info" ],
  build_type => "release",
  builddir => ".",
  ...
  minor => "1.1",
  openssl_algorithm_defines => [ "OPENSSL_NO_BF", "OPENSSL_NO_CAMELLIA", "OPENSSL_NO_CAST", "OPENSSL_NO_DH", "OPENSSL_NO_DSA", "OPENSSL_NO_EC", "OPENSSL_NO_IDEA", "OPENSSL_NO_MD2", "OPENSSL_NO_MD4", "OPENSSL_NO_MDC2", "OPENSSL_NO_RC2", "OPENSSL_NO_RC4", "OPENSSL_NO_RC5", "OPENSSL_NO_SEED", "OPENSSL_NO_SM2", "OPENSSL_NO_SRP", "OPENSSL_NO_WHIRLPOOL" ],
  openssl_api_defines => [  ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_AFALGENG", "OPENSSL_NO_ASAN", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_DGRAM", "OPENSSL_NO_DTLS", "OPENSSL_NO_DTLS1", "OPENSSL_NO_DTLS1_2", "OPENSSL_NO_EC_NISTP_64_GCC_128", "OPENSSL_NO_ECDH", "OPENSSL_NO_ECDSA", "OPENSSL_NO_EGD", "OPENSSL_NO_ENGINE", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_MSAN", "OPENSSL_NO_RFC3779", "OPENSSL_NO_SCTP", "OPENSSL_NO_SOCK", "OPENSSL_NO_SRTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_TLS1", "OPENSSL_NO_TLS1_3", "OPENSSL_NO_UBSAN", "OPENSSL_NO_UNIT_TEST", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_STATIC_ENGINE", "OPENSSL_NO_AFALGENG" ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "",
  options => "-D__ANDROID_API__=21 -D_FILE_OFFSET_BITS=64 -fPIC --sysroot=/tmp/sqlcipher-android-toolchain-arm64-v8a/sysroot no-afalgeng no-asan no-bf no-camellia no-cast no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dgram no-dh no-dsa no-dtls no-dtls1 no-dtls1_2 no-ec no-ec_nistp_64_gcc_128 no-ecdh no-ecdsa no-egd no-engine no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-idea no-md2 no-md4 no-mdc2 no-msan no-rc2 no-rc4 no-rc5 no-rfc3779 no-sctp no-seed no-sm2 no-sock no-srp no-srtp no-ssl-trace no-ssl3 no-ssl3-method no-tls1 no-tls1_3 no-ubsan no-unit-test no-weak-ssl-ciphers no-whirlpool no-zlib no-zlib-dynamic",
  perl_archname => "darwin-thread-multi-2level",
  perl_cmd => "perl",
  perl_version => "5.18.4",
  perlargv => [ "android-arm64", "-D__ANDROID_API__=21", "-D_FILE_OFFSET_BITS=64", "-fPIC", "no-idea", "no-camellia", "no-seed", "no-bf", "no-cast", "no-rc2", "no-rc4", "no-rc5", "no-md2", "no-md4", "no-ecdh", "no-sock", "no-ssl3", "no-dsa", "no-dh", "no-ec", "no-ecdsa", "no-tls1", "no-rfc3779", "no-whirlpool", "no-srp", "no-mdc2", "no-ecdh", "no-engine", "no-srtp", "--sysroot=/tmp/sqlcipher-android-toolchain-arm64-v8a/sysroot" ],
  perlenv => {
      "AR" => undef,
      "BUILDFILE" => undef,
      "CC" => undef,
  ...
  sdirs => [ "objects", "md5", "sha", "hmac", "ripemd", "poly1305", "blake2", "siphash", "sm3", "des", "aes", "aria", "sm4", "chacha", "modes", "bn", "rsa", "dso", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "comp", "ocsp", "ui", "cms", "ts", "cmac", "ct", "async", "kdf", "store" ],
  shlib_major => "1",
  shlib_minor => "1",
...
our %target = (
  ...
  cast_obj => "c_enc.o",
  cflags => "-pthread  -mandroid --sysroot=\$(ANDROID_NDK)/platforms/android-21/arch-arm64",
  ...
  cxxflags => "-std=c++11 -pthread  -mandroid --sysroot=\$(ANDROID_NDK)/platforms/android-21/arch-arm64",
  defines => [  ],
